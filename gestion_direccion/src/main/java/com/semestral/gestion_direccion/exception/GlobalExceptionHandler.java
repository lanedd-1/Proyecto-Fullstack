...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleExternalService(ExternalServiceException ex, HttpServletRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(new ErrorResponseDTO(LocalDateTime.now(), HttpStatus.SERVICE_UNAVAILABLE.value(),
                        HttpStatus.SERVICE_UNAVAILABLE.getReasonPhrase(), ex.getMessage(), req.getRequestURI(), null));
    }
