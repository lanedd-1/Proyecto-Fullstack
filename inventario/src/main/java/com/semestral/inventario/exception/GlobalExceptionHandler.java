package com.semestral.inventario.exception;
...
public ResponseEntity<ErrorResponseDTO> handleNotFoundException(NoSuchElementException ex, HttpServletRequest request) {
